...
class DeleteDataCard extends StatefulWidget {
  const DeleteDataCard({Key? key}) : super(key: key);

  @override
  State<DeleteDataCard> createState() => _DeleteDataCardState();
}

class _DeleteDataCardState extends State<DeleteDataCard> {
  @override
